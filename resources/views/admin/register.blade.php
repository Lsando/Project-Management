...
@section("page_title", translate('registo_novo_usuario'))
@section("page_title_active", translate('registo_novo_usuario'))
    ...
    <div class="row">
        <div class="block block-condensed">
            <div class="app-heading app-heading-small">
                <div class="title">
                    <h5>{{translate('formulario_registo_usuario')}}</h5>
                </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#btn_submit').on('click', function() {
                var $this = $(this);
                var loadingText = '<i class="fa fa-circle-o-notch fa-spin"></i> {{translate('processando')}}';
